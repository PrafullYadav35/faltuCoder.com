    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <i class="fas fa-laugh-wink"></i>
                ...
                <div class="sidebar-brand-text mx-3">E-Tutor Admin</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" onclick="<?php session_start();

// Clear all session data
session_unset(); // Optional: Unset specific session variables if needed

// Destroy the session
session_destroy(); ?>"  href="admin-login.php">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="images/Images.png" alt="...">
